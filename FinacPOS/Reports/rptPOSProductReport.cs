...
namespace FinacPOS
{
    public partial class rptPOSProductReport : Form
    {
        public rptPOSProductReport()
        {
            InitializeComponent();
        }
        #region DECLARATIONS
        ...
        #endregion
        private void rptPOSProductReport_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void rptPOSProductReport_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
             ...
             if (groupIds == "")
            {
             ...
             else
             {
                 ...
                 if (rbtnBillDate.Checked == true)
                 {
                     ...
                     if (reportnamepart == "Category wise sales report" || reportnamepart == "Product wise sales report")
                         dtblReport = objPOSReportSP.POSProductReport(Convert.ToDateTime(dtpFrom.Text), Convert.ToDateTime(dtpTo.Text), "BILLDATE", cmbReportType.SelectedItem.ToString());
                     else if (reportnamepart == "Product wise sales profit report" || reportnamepart == "Category wise sales profit report")
                         dtblReport = objPOSReportSP.POSProductProfitReport(Convert.ToDateTime(dtpFrom.Text), Convert.ToDateTime(dtpTo.Text), "BILLDATE", cmbReportType.SelectedItem.ToString());
                 }
                 else if (rbtnSessionDate.Checked == true)
                 {
                     strReportName = reportnamepart + " - " + cmbReportType.Text.Trim() + " (Session Date)";
                     if (reportnamepart == "Category wise sales report" || reportnamepart == "Product wise sales report")
                         dtblReport = objPOSReportSP.POSProductReport(Convert.ToDateTime(dtpFrom.Text), Convert.ToDateTime(dtpTo.Text), "SESSIONDATE", cmbReportType.SelectedItem.ToString());
                     else if (reportnamepart == "Product wise sales profit report" || reportnamepart == "Category wise sales profit report")
                         dtblReport = objPOSReportSP.POSProductProfitReport(Convert.ToDateTime(dtpFrom.Text), Convert.ToDateTime(dtpTo.Text), "SESSIONDATE", cmbReportType.SelectedItem.ToString());
                 }
     ...
     //                }
                     ...
                     else
                     {
                         ...
                         {
                             frmreportviewobj.POSProductReportPRoductwisePrinting(dtblReport, dtblCompanyDetails, strReportName, strDatePeriod);
                         }
