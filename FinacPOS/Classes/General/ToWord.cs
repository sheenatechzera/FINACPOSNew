...
namespace FinacPOS
{
    class ToWord
    {
        ...
        /// Currency to use
        /// </summary>
        public CurrencyArabicInfo Currency { get; set; }
        ...
        public ToWord(Decimal number, CurrencyArabicInfo currency)
        {
        ...
        public ToWord(Decimal number, CurrencyArabicInfo currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
        ...
        /// <param name="arabicPrefixText">Arabic text to be placed before the generated text</param>
        /// <param name="arabicSuffixText">Arabic text to be placed after the generated text</param>
        private void InitializeClass(Decimal number, CurrencyArabicInfo currency, String englishPrefixText, String englishSuffixText, String arabicPrefixText, String arabicSuffixText)
        {
            Number = number;
            Currency = currency;
        ...
        public string ConvertToArabic()
        {
            ...
            while (tempNumber >= 1)
            {
                ...
                { // here we add the new converted group to the previous concatenated text
                    ...
                    retVal = String.Format("{0}{1}", groupDescription, retVal); //no change
                }
