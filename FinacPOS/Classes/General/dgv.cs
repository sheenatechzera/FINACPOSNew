...
namespace FinacPOS
{
    class dgv
    {
        ...
        //**********************Enter Key Navigation on Data Grid View *********************************************
            ...
            protected override bool ProcessDialogKey(Keys keyData)
           {
                ...
                else if (key == Keys.Back&& base.CurrentCell!=null )
                {
                    ...
                    if (base.CurrentCell.OwningColumn.CellType.ToString() == "System.Windows.Forms.DataGridViewTextBoxCell" && base.CurrentCell.ReadOnly == false)
                    {
                        ...
                        if ((base.CurrentCell.Value == null || base.CurrentCell.Value.ToString() == "" )&& editControl.AutoCompleteMode==AutoCompleteMode.None)
                        {
                            base.EndEdit();
                            return this.ProcessLeftKey(keyData);
                        }
                        else
                        {
                            ...
                            if ((editControl != null) && (((editControl.Text.Length == 0 || editControl.SelectionStart == 0) && (editControl.AutoCompleteMode == AutoCompleteMode.None)) || (editControl.Text.Length == 0)))
                            {
                                base.EndEdit();
                                return this.ProcessLeftKey(keyData);
                            }
                ...
                try
                {
                    ...
                    if (key == Keys.Enter)
                    {
                        if (base.CurrentCell != null)
                        {
                            ...
                            if (index == base.Columns.Count - 3 && !(base.Columns[base.Columns.Count - 2].Visible) && (!base.Columns[base.Columns.Count - 1].Visible))
                            {
                                index += 2;
                            }
