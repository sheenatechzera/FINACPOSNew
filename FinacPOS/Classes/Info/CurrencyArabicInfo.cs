...
namespace FinacPOS
{
    public class CurrencyArabicInfo
    {
        //public enum Currencies { Syria = 0, UAE, SaudiArabia, Tunisia, Gold };

        #region Constructors

        public CurrencyArabicInfo(string currencyName)
        {
            switch (currencyName)
            {
                case "Syria":
                ...
                case "RO":
                    ...
                    CurrencyCode = "ro";
                    IsCurrencyNameFeminine = false;
                    EnglishCurrencyName = "Oman Riyal";
                    EnglishPluralCurrencyName = "Oman Riyals";
                    EnglishCurrencyPartName = "Baiza";
                    EnglishPluralCurrencyPartName = "Baizas";
                    Arabic1CurrencyName = "ريال عماني";
                    Arabic2CurrencyName = "ريال عماني";
                    Arabic310CurrencyName = "ريالات عمان ";
                    Arabic1199CurrencyName = "ريالاً عمان";
                    Arabic1CurrencyPartName = "بيسة";
                    Arabic2CurrencyPartName = "بيسة";
                    Arabic310CurrencyPartName = "بيسة";
